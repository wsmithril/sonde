...
//!
//! The probe runs one of six mutually-exclusive modes, cycled on each reset so
...
//!   • Midea ctrl   — active central specialised to Midea appliances: detect,
//!                    handshake, subscribe and read status.
//!
